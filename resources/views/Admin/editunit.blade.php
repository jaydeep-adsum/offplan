                                ...
                                @foreach ($project['paymentplan'] as $key => $payment)
                                    <div class="removeMilestone" data_milestone="{{$key}}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class='col-6'>
                                                <h6 class='text-center'><a href='javascript:void(0)' onclick='deleteConfirmation(this,{{$payment->id}})'>Delete</a></h6>
                                            </div>
                                        </div>
                                        <hr>
                            ...
                            <div class="editRemove">
                                <div class='removeMilestone' data_milestone="0">
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class='col-6'>
                                            <h6 class='text-center'><a href='javascript:void(0)' style="visibility: hidden" onclick='deleteConfirmation(this,0)'>Delete</a></h6>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="form-row justify-content-between mile">
...
@section('scripts')
    <script>
        ...
        function deleteConfirmation(el, id)
        {
            $.ajax({
                url: "{{route('deleteUnitMilestone')}}",
                type: "POST",
                data: {
                    id: id,
                    _token: '{{csrf_token()}}'
