            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Outdated Units</h3>
                    </div>
                    <div class="card-header">
                        <form class="form-inline ml-3" style="font-size: .8rem" method="post" id="Search"
                            autocomplete="off">
                            @csrf
                            <div class="row">
                                <div class="input-group col-3 mb-3">
                                    <select class="custom-select select-community mr-3 select2" id="community"
                                        name="community">
                                        @if($community)
                                ...
                                <div class="input-group col-3 mb-3">
                                    <select class="form-control mr-3 select-bedrooms select2" id="bedrooms"
                                        name="bedrooms">
                                ...
                                <div class="input-group col-3 mb-3">
                                    <select class="custom-select select-project mr-3 select2" id="project"
                                        name="project">
                                        @if($project)
                                ...
                                <div class="input-group col-3 mb-3">
                                    <select class="form-control select-company mr-3 select2" id="company"
                                        name="company">
