            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Ready Project</h3>
                    </div>
                    <div class="card-header">
                        <h5 class="card-header-text"></h5>
                        <span class="card-header-right-span"><a href="{{ route('addReadyProject')}}" class="btn btn-info "><i class="fa fa-plus"></i> Add Project</a></span>
                    </div>
                    <div class="card-header">
        ...
        var table = $('.datatableManageProject').DataTable({
            ...
            ajax: {
                ...
                data: function (d) {
                    ...
                    d.page_status = 'manage_ready_project'
                }
            },
            columns: [{
                    data: 'rf_no',
