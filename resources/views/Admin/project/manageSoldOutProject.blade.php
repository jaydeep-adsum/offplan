            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Sold Out Project</h3>
                    </div>
                    <div class="card-header">
                        <h5 class="card-header-text"></h5>
                        <span class="card-header-right-span"><a href="{{ route('addSoldOutProject')}}" class="btn btn-info "><i class="fa fa-plus"></i> Add Project</a></span>
                    </div>
                    <div class="card-header">
                        <form class="form-inline ml-3" style="font-size: .8rem" method="post" id="Search" autocomplete="off">
                            ...
                            <div class="row form-group w-100">
                                ...
                                <div class="input-group col-sm-3 mb-3">
                                    <select name="project_status" class="form-control select2" id="project_status" onchange="completionStatusHideShow(this.value)">
                                        <option value="" selected>Select Project Status</option>
                                        <option value="1">Ready</option>
                                        <option value="2">Quarter and Year</option>
                                    </select>
                                </div>
                                <div class="input-group col-sm-3 mb-3 completion_status_hide_show">
...
<script type="text/javascript">
    ...
    function completionStatusHideShow(value) 
    {
        if (value == 2) {
            ...
            $('#quarter').empty();
            $('#quarter').append(
                '<option selected value="">Select Quarter</option><option value="Q1">Q1</option><option value="Q2">Q2</option><option value="Q3">Q3</option><option value="Q4">Q4</option>'
            );
            $('#handover_year').val('');
        ...
        var table = $('.datatableManageProject').DataTable({
            ...
            ajax: {
                ...
                data: function (d) {
                    ...
                    d.page_status = 'manage_sold_out_project'
                }
            },
            columns: [{
                    data: 'rf_no',
