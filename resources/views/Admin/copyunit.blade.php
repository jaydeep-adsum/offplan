            ...
            <form class="form-horizontal" method="POST" id="frmTarget" enctype="multipart/form-data" autocomplete="off">
                <div class="form-row justify-content-between">
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" name="handover_year" id="handover_year" class="form-control"
                ...
                <div class="form-row justify-content-between">
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            <label>Price</label>
                            <div class="input-group mb-3">
                                <input type="number" value="{{$project->price}}" onchange="rowcol(this)" class="form-control am" id="price"
                                    name="price" min="0" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==8) return false;" placeholder="Enter Price">
                                <div class="input-group-append">
                ...
                <div class="form-row justify-content-between">
                    <div class="col-5">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3 ">
                                <input type="number" value="{{$project->construction_status}}" class="form-control" id="construction_status" min="0"
                ...
                <div style="border:solid 1px #ddd; padding:10px;" id="cont">
                    ...
                    <div class="grid-container row">
                        ...
                        <div class="col-3">
                            <input type="checkbox" id="vehicle1" name="featuresList[]"
                ...
                <div class="card show_hide"
                    ...
                    <div class="form-row justify-content-between">
                        <div class="col-6 mb-3">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="number" readonly="readonly" value="{{$project->up_to_handover}}" name="up_to_handover" id="pre_amount"
                                        class="form-control" min="0" placeholder="Enter Pre-Handover Amount">
                                    <div class="input-group-append">
                                        <span class="input-group-text" id="basic-addon2">AED</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-6 mb-3">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="number" min="0" readonly="readonly" value="{{$project->post_handover}}" name="post_handover" id="amount"
                    ...
                    <div class="form-row justify-content-between">
                        <div class="col-4 mb-3">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="number" min="0" name="pre_handover_amount" id="pre_amount"
                        ...
                        <div class="col-4 mb-3">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="number" min="0" name="handover_amount" id="amount"
                        ...
                        <div class="col-4 mb-3">
                            <div class="form-group">
                                <label>Post-Handover Amount</label>
                                <div class="input-group mb-3">
                                    <input type="number" min="0" name="post_handover_amount" id="amount"
                    ...
                    @if ( !($project->paymentplan->isEmpty() ))
                        ...
                        <div data_milestone="{{$key}}" class="form-row justify-content-between mile">
                            <div class="col-5 mb-3">
                                ...
                                <input type="number" min="0" name="milestone[{{$key}}][installment_terms]"
                                    value="{{$payment->installment_terms}}" id="installment" class="form-control" placeholder="Enter Installment">
                            </div>
                            <div class="col-5 mb-3">
                                <label>Payment Milestone</label>
                                @if($milestoneData)
                                <select class="form-control" id="milestone" name="milestone[{{$key}}][milestones]">
                            ...
                            <div class="col-5 mb-3">
                                ...
                                <input type="number" min="0" name="milestone[{{$key}}][percentage]" onchange="precalc(this)" value="{{$payment->percentage}}"
                                    id="percentage" class="form-control per" placeholder="Enter Percentage">
                            </div>
                            <div class="col-5 mb-3">
                                <div class="form-group">
                                    <label>Amount</label>
                                    <div class="input-group mb-3">
                                        <input type="number" min="0" name="milestone[{{$key}}][amount]" value="{{$payment->amount}}"
                                            id="total_amount" class="form-control total" placeholder="Enter Amount">
                                        <div class="input-group-append">
                                            <span class="input-group-text" id="basic-addon2">AED</span>
                                        </div>
                                    </div>
                        ...
                        <div class="form-row justify-content-between mile">
                            <div class="col-5 mb-3">
                                <label>Installment Terms</label>
                                <input type="number" min="0" name="milestone[0][installment_terms]" id="installment"
                                    class="form-control" placeholder="Enter Installment">
                            </div>
                            <div class="col-5 mb-3">
                                <label>Payment Milestone</label>
                                @if($milestoneData)
                                <select class="form-control" id="milestone" name="milestone[0][milestones]">
                                    <option selected disabled>Select Milestone</option>
                            ...
                            <div class="col-5 mb-3 abc">
                                <label>Percentage</label>
                                <input type="number" min="0" name="milestone[0][percentage]" onchange="precalc(this)"  id="percentage" class="form-control per"
                            ...
                            <div class="col-5 mb-3 abc">
                                <div class="form-group">
                                    <label>Amount</label>
                                    <div class="input-group mb-3">
                                        <input type="number" min="0" name="milestone[0][amount]" id="total_amount" class="form-control total"
...
<script type="text/javascript">
    ...
    document.getElementById("floorplanimage").onchange = function (event) {
        ...
        console.log(floorplanimageArray);
    }
...
<script>
    $(".add-row").click(function () {
        ...
        var add =
            ...
            index +
            "][installment_terms]' id='installment' class='form-control' placeholder='Enter Installment'> </div><div class='col-5 mb-3'> <label>Payment Milestone</label>@if($milestoneData)<select class='form-control' id='milestone' name='milestone[" +
            index +
            ...
            index +
            "][percentage]' onchange='precalc(this)' id='percentage' class='form-control per' placeholder='Enter Percentage'></div><div class='col-5 mb-3'><div class='form-group'><label>Amount</label><div class='input-group mb-3'><input type='number' min='0' name='milestone[" +
            index + "][amount]' id='amount' class='form-control total' placeholder='Enter Amount'><div class='input-group-append'><span class='input-group-text' id='basic-addon2'>AED</span></div></div></div></div></div>"
        $(".add-row").before(add);
    });
