            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Ready Units</h3>
                    </div>
                    @if($permission)
                        @if($permission->create)
                            <div class="card-header">
                                <h5 class="card-header-text"></h5>
                                <span class="card-header-right-span"><a href="{{ route('add_ready_unit')}}" class="btn btn-info "><i class="fa fa-plus"></i> Add Unit</a></span>
                            </div>
                        @endif
                    @endif
                    <div class="card-header">
                        <form class="form-inline" style="font-size: .8rem" method="post" id="Search" autocomplete="off">
                            @csrf
                            <div class="row">
                                <div class="input-group col-3 mb-3">
                                    <select class="custom-select select-community mr-3 select2" id="community" name="community">
                                        @if($community)
                                ...
                                <div class="input-group col-3 mb-3">
                                    <select class="custom-select select-subcommunity mr-3 select2" name="subcommunity"
                                        id="subcommunity">
                                        <option selected disabled value="">Select Sub Community</option>
                                    </select>
                                </div>
                                <div class="input-group col-3 mb-3">
                                    <select class="form-control select-property mr-3 select2" name="property">
                                ...
                                <div class="input-group col-3 mb-3">
                                    <select class="form-control mr-3 select-bedrooms select2" id="bedrooms" name="bedrooms">
                                ...
                                <div class="input-group col-3 mb-3">
                                    <input type="number" name="min_price" placeholder="Price From"
                                        class="form-control mr-3 select-min-price">
                                </div>
                                <div class="input-group col-3 mb-3">
                                    <input type="number" name="max_price" placeholder="Price To"
                                        class="form-control mr-3 select-max-price">
                                </div>
                                <div class="input-group col-3 mb-3">
                                    <input type="number" name="min_size" placeholder="Size From"
                                        class="form-control mr-3 select-min-size">
                                </div>
                                <div class="input-group col-3 mb-3">
                                    <input type="number" name="max_size" placeholder="Size To"
                                        class="form-control mr-3 select-max-size">
                                </div>
                                <div class="input-group col-3 mb-3">
                                    <select class="custom-select select-project mr-3 select2" id="project" name="project">
                                        @if($project)
                                ...
                                <div class="input-group col-3 mb-3">
                                    <select class="form-control select-company mr-3 select2" id="company" name="company">
                                ...
                                <div class="input-group col-3 mb-3">
                                    <select class="form-control mr-3 select-payment-plan select2" name="payment_plan">
                                ...
                                <div class="input-group col-3 mb-3">
                                    <input type="number" name="amount-upto-handover" id="amount-upto-handover"
                                        ...
                                        class="form-control mr-3 select-amount-upto-handover">
                                </div>
                                <div class="input-group col-3 mb-3">
                                    <input type="number" name="post-handover" id="post-handover"
                                        placeholder="Amount Post Handover"
                                        class="form-control mr-3 select-post-handover">
                                </div>
                                <div class="input-group col-3 mb-3">
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $.each(result.subcommunity, function (key, value) {
                        $("#subcommunity").append('<option value="' + value.id + '">' + value
                            .name + '</option>');
                    });
                }
            });
